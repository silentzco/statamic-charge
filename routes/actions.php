...
// Subscriptions
Route::get('subscription/{name}', [SubscriptionController::class, 'show'])->name('charge.subscription.show');
Route::post('subscription', [SubscriptionController::class, 'store'])->name('charge.subscription.store');
Route::delete('subscription/{name}', [SubscriptionController::class, 'destroy'])->name('charge.subscription.destroy');
